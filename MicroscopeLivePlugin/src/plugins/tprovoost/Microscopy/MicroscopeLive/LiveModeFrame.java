 ...
 */
public class LiveModeFrame extends LiveSequence implements StageListener
{
        ...
        public void run()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    if (video.getWidth() != (int) core.getImageWidth()
                            || video.getHeight() != (int) core.getImageHeight())
                    {
